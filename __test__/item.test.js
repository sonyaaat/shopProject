...
const backButton = screen.getByText('Back');
    ...
    expect(store.getState().main.selectedItem).toEqual({"description": "Test Description", "image": "test.jpg", "name": "Test Item", "price": 10, "quantity": 5})
  });
  it('should call addToBasket when Add to basket button is clicked', () => {
    ...
    // expect(addToBasketMock).toHaveBeenCalledWith({ id: '1' });
  });
});
